...
public class Pose_BodyBuli : MonoBehaviour {
    ...
    {
        //ポーズガイドの画像
        pause_bodybuli = gameObject.GetComponent<Image>();
        r = pause_bodybuli.GetComponent<Image>().color.r;
        g = pause_bodybuli.GetComponent<Image>().color.g;
    ...
    //ポーズの画像を表示させる
    public void bodybuliPoseDisplaytrue()
    {
        alpha = 1.0f;
    }

    //ポーズの画像を表示させない
    public void bodybuliPoseDisplayfalse()
    {
        alpha = 0.0f;
    }
}
