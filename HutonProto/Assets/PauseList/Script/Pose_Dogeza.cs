...
public class Pose_Dogeza : MonoBehaviour
{
    ...
    private bool imageDisplay = false;

    //ポーズの各腕、足がそれぞれ指定された範囲内に入っているか
    //falseが入ってない、trueが入ってる
    protected bool R_arm_flag = false;
    protected bool R_leg_flag = false;
    protected bool L_arm_flag = false;
    ...
    void Update()
    {
        ...
        /*角度の判定の上下許容範囲*/
        //右肩
        R_shoulderP = R_shoulder + 20.0f;
        R_shoulderM = R_shoulder - 20.0f;
        //右ひじ
