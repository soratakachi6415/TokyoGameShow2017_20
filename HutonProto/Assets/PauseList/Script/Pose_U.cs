...
public class Pose_U : MonoBehaviour
{
    ...
    //成功したポーズの判定で使う
    public string Pausename = "pause_U";
    //ポーズが決まったか
    ...
    {
        //ポーズガイドの画像
        pause_U = gameObject.GetComponent<Image>();
        r = pause_U.GetComponent<Image>().color.r;
        g = pause_U.GetComponent<Image>().color.g;
        b = pause_U.GetComponent<Image>().color.b;
        alpha = pause_U.GetComponent<Image>().color.a;
    ...
    {
        //ポーズの画像の情報
        pause_U.GetComponent<Image>().color = new Color(r, g, b, alpha);
        //画像をプレイヤーの上、X、Yの調整
