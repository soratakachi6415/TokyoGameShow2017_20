...
public class Pose_frog : MonoBehaviour {
    ...
    //成功したポーズの判定で使う
    public string Pausename = "pause_frog";
    ...
    {
        //ポーズガイドの画像
        pause_frog = gameObject.GetComponent<Image>();
        r = pause_frog.GetComponent<Image>().color.r;
        g = pause_frog.GetComponent<Image>().color.g;
        b = pause_frog.GetComponent<Image>().color.b;
        alpha = pause_frog.GetComponent<Image>().color.a;
        //プレイヤーの関節の角度など
    ...
    void Update()
    {
        ...
        /***************************************/
        pause_frog.GetComponent<Image>().color = new Color(r, g, b, alpha);
