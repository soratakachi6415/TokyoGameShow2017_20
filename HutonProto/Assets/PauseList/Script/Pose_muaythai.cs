...
public class Pose_muaythai : MonoBehaviour { 

    //プレイヤーの角度参照
    PlayerStatus playerstatus;
    /*ポーズ_大の字の判定を行う*/
    //「大」ポーズの画像を所得
    private Image pose_muaythai;
    ...
    //成功したポーズの判定で使う
    public string posename = "pose_muaythai";
    //ポーズが決まったか
    public bool DecidePose_muaythai;
    ...
    {
        //ポーズガイドの画像
        pose_muaythai = gameObject.GetComponent<Image>();
        r = pose_muaythai.GetComponent<Image>().color.r;
        g = pose_muaythai.GetComponent<Image>().color.g;
        b = pose_muaythai.GetComponent<Image>().color.b;
        alpha = pose_muaythai.GetComponent<Image>().color.a;
        //プレイヤーの関節の角度など
    ...
    //ポーズの画像を表示させる
    public void muaythaiPoseDisplaytrue()
    {
        alpha = 1.0f;
    }
    //ポーズの画像を表示させない
    public void muaythaiPoseDisplayfalse()
    {
        alpha = 0.0f;
    }
}
