...
public class Pose_spuat : MonoBehaviour {

    PlayerStatus playerstatus;

    /*ポーズ_バナナの判定を行う*/
    //「バナナ」ポーズの画像を所得
    protected Image pose_spuat;
    ...
    //成功したポーズの判定で使う
    public string posename = "pose_spuat";

    void Start()
    {
        //ポーズガイドの画像
        pose_spuat = gameObject.GetComponent<Image>();
        r = pose_spuat.GetComponent<Image>().color.r;
        g = pose_spuat.GetComponent<Image>().color.g;
    ...
    void Update()
    {
        ...
        /***************************************/
        pose_spuat.GetComponent<Image>().color = new Color(r, g, b, alpha);
    ...
    //ポーズの画像を表示させる
    public void spuatPoseDisplaytrue()
    {
        alpha = 1.0f;
    }

    //ポーズの画像を表示させない
    public void spuatPoseDisplayfalse()
    {
        alpha = 0.0f;
    }
}
