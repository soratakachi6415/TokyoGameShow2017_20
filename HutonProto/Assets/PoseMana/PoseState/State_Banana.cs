...
public class State_Banana : MonoBehaviour {
    ...
    /****ポーズオブジェクトの取得****/
    // バナナのオブジェクトを取得
    private Image _Banana;
    public Pose_Banana _banana;
    ...
    void Start () {
        ...
        _Banana = GameObject.Find("Pose_Banana").GetComponent<Image>();
        _banana = _Banana.GetComponent<Pose_Banana>();
    ...
    void Update ()
    {
        ...
        if (_banana.L_arm_flag == true ||
            _banana.R_arm_flag == true ||
            _banana.L_leg_flag == true ||
            _banana.R_leg_flag == true)
        {
            _chance = true;
            ChanceDisPlayTrue();
        }
    ...
    {
        if ((_banana.R_arm_flag == true &&
            _banana.L_arm_flag == true) ||
            (_banana.R_leg_flag == true &&
            _banana.L_leg_flag == true))
        {
            _posemanager._Pose = PoseManager.PoseState.Banana;
        }
