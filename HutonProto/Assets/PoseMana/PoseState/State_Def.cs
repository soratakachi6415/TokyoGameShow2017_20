...
public class State_Def : MonoBehaviour {
    ...
    /****ポーズオブジェクトの取得****/
    // 開脚のオブジェクトを取得
    private Image _Defolt;
    public Pose_Defo _defolt;
    ...
    void Start()
    {
        ...
        _Defolt = GameObject.Find("Pose_Defolt").GetComponent<Image>();
        _defolt = GameObject.Find("Pose_Defolt").GetComponent<Pose_Defo>();
    ...
    void Update()
    {
        ...
        if (_defolt.L_arm_flag == true ||
            _defolt.R_arm_flag == true ||
            _defolt.L_leg_flag == true ||
            _defolt.R_leg_flag == true)
        {
            _chance = true;
            ChanceDisPlayTrue();
        }
    ...
    {
        if ((_defolt.R_arm_flag == true &&
            _defolt.L_arm_flag == true) ||
            (_defolt.R_leg_flag == true &&
            _defolt.L_leg_flag == true))
        {
            _posemanager._Pose = PoseManager.PoseState.Deformed;
        }
