...
public class State_F : MonoBehaviour {
    ...
    /****ポーズオブジェクトの取得****/
    // アルファベットFのオブジェクトを取得
    private Image _AlphaF;
    public Pose_F _alphaF;
    ...
    void Start () {
        ...
        _AlphaF = GameObject.Find("Pose_F").GetComponent<Image>();
        _alphaF = _AlphaF.GetComponent<Pose_F>();
    ...
    void Update ()
    {
        ...
        if (_alphaF.L_arm_flag == true ||
             _alphaF.R_arm_flag == true ||
             _alphaF.L_leg_flag == true ||
             _alphaF.R_leg_flag == true)
        {
            _chance = true;
            ChanceDisPlayTrue();
        }
    ...
    {
        if ((_alphaF.R_arm_flag == true &&
           _alphaF.L_arm_flag == true) ||
           (_alphaF.R_leg_flag == true &&
           _alphaF.L_leg_flag == true))
        {
            _posemanager._Pose = PoseManager.PoseState.AlphaF;
        }
