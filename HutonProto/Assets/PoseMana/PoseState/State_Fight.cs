...
public class State_Fight : MonoBehaviour {
    ...
    /****ポーズオブジェクトの取得****/
    // 開脚のオブジェクトを取得
    private Image _Fught;
    public Pose_Fight _fight;
    ...
    void Start()
    {
        ...
        _Fught = GameObject.Find("Pose_Fight").GetComponent<Image>();
        _fight = _Fught.GetComponent<Pose_Fight>();
    ...
    void Update()
    {
        ...
        if (_fight.L_arm_flag == true ||
            _fight.R_arm_flag == true ||
            _fight.L_leg_flag == true ||
            _fight.R_leg_flag == true)
        {
            _chance = true;
            ChanceDisPlayTrue();
        }
    ...
    {
        if ((_fight.R_arm_flag == true &&
            _fight.L_arm_flag == true) ||
            (_fight.R_leg_flag == true &&
            _fight.L_leg_flag == true))
        {
