...
public class State_Frog : MonoBehaviour {
    ...
    void Start()
    {
        ...
        _Frog = GameObject.Find("Pose_frog").GetComponent<Image>();
        _frog = _Frog.GetComponent<Pose_frog>();
    ...
    void Update()
    {
        ...
        if (_frog.L_arm_flag == true ||
            _frog.R_arm_flag == true ||
            _frog.L_leg_flag == true ||
            _frog.R_leg_flag == true)
        {
            _chance = true;
            ChanceDisPlayTrue();
        }
    ...
    {
        if ((_frog.R_arm_flag == true &&
            _frog.L_arm_flag == true) ||
            (_frog.R_leg_flag == true &&
            _frog.L_leg_flag == true))
        {
            _posemanager._Pose = PoseManager.PoseState.Frog;
        }
