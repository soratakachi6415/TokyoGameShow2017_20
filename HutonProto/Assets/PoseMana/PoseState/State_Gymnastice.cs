...
public class State_Gymnastice : MonoBehaviour {
    ...
    /****ポーズオブジェクトの取得****/
    // 開脚のオブジェクトを取得
    private Image _Gymnasice;
    public Pose_Gymnastice _gymnasice;
    ...
    void Start()
    {
        ...
        _Gymnasice = GameObject.Find("Pose_Gymnastice").GetComponent<Image>();
        _gymnasice = _Gymnasice.GetComponent<Pose_Gymnastice>();
    ...
    void Update()
    {
        ...
        if (_gymnasice.L_arm_flag == true ||
            _gymnasice.R_arm_flag == true ||
            _gymnasice.L_leg_flag == true ||
            _gymnasice.R_leg_flag == true)
        {
            _chance = true;
            ChanceDisPlayTrue();
        }
    ...
    {
        if ((_gymnasice.R_arm_flag == true &&
            _gymnasice.L_arm_flag == true) ||
            (_gymnasice.R_leg_flag == true &&
            _gymnasice.L_leg_flag == true))
        {
            _posemanager._Pose = PoseManager.PoseState.Gymnastics;
        }
