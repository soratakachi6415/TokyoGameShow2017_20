...
public class State_Hawk : MonoBehaviour {
    ...
    void Start()
    {
        ...
        _Hawk = GameObject.Find("Pose_Hawk").GetComponent<Image>();
        _hawk = _Hawk.GetComponent<Pose_Hawk>();
    ...
    void Update()
    {
        ...
        if (_hawk.L_arm_flag == true ||
            _hawk.R_arm_flag == true ||
            _hawk.L_leg_flag == true ||
            _hawk.R_leg_flag == true)
        {
            _chance = true;
            ChanceDisPlayTrue();
        }
    ...
    {
        if ((_hawk.R_arm_flag == true &&
            _hawk.L_arm_flag == true) ||
            (_hawk.R_leg_flag == true &&
            _hawk.L_leg_flag == true))
        {
            _posemanager._Pose = PoseManager.PoseState.Pose_of_Turbulent_hawk;
        }
