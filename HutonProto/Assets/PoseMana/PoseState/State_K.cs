...
public class State_K : MonoBehaviour {
    ...
    /****ポーズオブジェクトの取得****/
    // 開脚のオブジェクトを取得
    private Image _AlphaK;
    public Pose_K _alphaK;
    ...
    void Start()
    {
        ...
        _AlphaK = GameObject.Find("Pose_K").GetComponent<Image>();
        _alphaK = _AlphaK.GetComponent<Pose_K>();
    ...
    void Update()
    {
        ...
        if (_alphaK.L_arm_flag == true ||
            _alphaK.R_arm_flag == true ||
            _alphaK.L_leg_flag == true ||
            _alphaK.R_leg_flag == true)
        {
            _chance = true;
            ChanceDisPlayTrue();
        }
    ...
    {
        if ((_alphaK.R_arm_flag == true &&
            _alphaK.L_arm_flag == true) ||
            (_alphaK.R_leg_flag == true &&
            _alphaK.L_leg_flag == true))
        {
            _posemanager._Pose = PoseManager.PoseState.AlphaK;
        }
