...
public class State_Muaythai : MonoBehaviour {
    ...
    /****ポーズオブジェクトの取得****/
    // 開脚のオブジェクトを取得
    private Image _Muaytai;
    public Pose_muaythai _muaytai;
    ...
    void Start()
    {
        ...
        _Muaytai = GameObject.Find("Pose_muaythai").GetComponent<Image>();
        _muaytai = _Muaytai.GetComponent<Pose_muaythai>();
    ...
    void Update()
    {
        ...
        if (_muaytai.L_arm_flag == true ||
            _muaytai.R_arm_flag == true ||
            _muaytai.L_leg_flag == true ||
            _muaytai.R_leg_flag == true)
        {
            _chance = true;
            ChanceDisPlayTrue();
        }
    ...
    {
        if ((_muaytai.R_arm_flag == true &&
            _muaytai.L_arm_flag == true) ||
            (_muaytai.R_leg_flag == true &&
            _muaytai.L_leg_flag == true))
        {
            _posemanager._Pose = PoseManager.PoseState.Muay_thai;
        }
