...
public class State_Painfull : MonoBehaviour {
    ...
    public Pose_painfullpose1 _painfull;
    ...
    void Start()
    {
        ...
        _Painfull = GameObject.Find("Pose_PainfulPose1").GetComponent<Image>();
        _painfull = _Painfull.GetComponent<Pose_painfullpose1>();
    ...
    public void FlagCheck()
    {
        if ((_painfull.R_arm_flag == true &&
            ...
            _painfull.L_leg_flag == true))
        {
            _posemanager._Pose = PoseManager.PoseState.Sophomoric_1;
        }
