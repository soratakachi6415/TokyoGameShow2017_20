...
public class State_Painfull1 : MonoBehaviour {
    ...
    /****ポーズオブジェクトの取得****/
    // 開脚のオブジェクトを取得
    private Image _Painfull;
    public Pose_painfullPose2 _painfull;
    ...
    void Start()
    {
        ...
        _Painfull = GameObject.Find("Pose_painfullpose2").GetComponent<Image>();
        _painfull = _Painfull.GetComponent<Pose_painfullPose2>();
    ...
    void Update()
    {
        ...
        if (_painfull.L_arm_flag == true ||
            _painfull.R_arm_flag == true ||
            _painfull.L_leg_flag == true ||
            _painfull.R_leg_flag == true)
        {
            _chance = true;
            ChanceDisPlayTrue();
        }
    ...
    {
        if ((_painfull.R_arm_flag == true &&
            _painfull.L_arm_flag == true) ||
            (_painfull.R_leg_flag == true &&
            _painfull.L_leg_flag == true))
        {
            _posemanager._Pose = PoseManager.PoseState.Sophomoric_2;
        }
