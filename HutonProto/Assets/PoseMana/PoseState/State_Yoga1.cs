...
public class State_Yoga1 : MonoBehaviour {
    ...
    void Start()
    {
        ...
        _Yoga = GameObject.Find("Pose_yoga1").GetComponent<Image>();
        _yoga = _Yoga.GetComponent<Pose_yoga1>();
    ...
    void Update()
    {
        ...
        if (_yoga.L_arm_flag == true ||
            _yoga.R_arm_flag == true ||
            _yoga.L_leg_flag == true ||
            _yoga.R_leg_flag == true)
        {
            _chance = true;
            ChanceDisPlayTrue();
        }
    ...
    {
        if ((_yoga.R_arm_flag == true &&
            _yoga.L_arm_flag == true) ||
            (_yoga.R_leg_flag == true &&
            _yoga.L_leg_flag == true))
        {
            _posemanager._Pose = PoseManager.PoseState.Yoga_1;
        }
