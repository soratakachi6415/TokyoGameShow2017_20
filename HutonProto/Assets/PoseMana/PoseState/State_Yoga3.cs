...
public class State_Yoga3 : MonoBehaviour {
    ...
    void Start()
    {
        ...
        _Yoga = GameObject.Find("Pose_yoga3").GetComponent<Image>();
        _yoga = _Yoga.GetComponent<Pose_yoga3>();
    ...
    public void FlagCheck()
    {
        if ((_yoga.R_arm_flag == true &&
            ...
            _yoga.L_leg_flag == true))
        {
            _posemanager._Pose = PoseManager.PoseState.Yoga_3;
        }
