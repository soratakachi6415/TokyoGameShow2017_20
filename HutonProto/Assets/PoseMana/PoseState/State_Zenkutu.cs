...
public class State_Zenkutu : MonoBehaviour {
    ...
    /****ポーズオブジェクトの取得****/
    // 前屈のオブジェクトを取得
    private Image _Zenkutu;
    public Pose_Zenkutu _zenkutu;
    ...
    void Start () {
        ...
        _Zenkutu = GameObject.Find("Pose_Zenkutu").GetComponent<Image>();
        _zenkutu = _Zenkutu.GetComponent<Pose_Zenkutu>();
    ...
    void Update ()
    {
        ...
        if (_zenkutu.L_arm_flag == true ||
            _zenkutu.R_arm_flag == true ||
            _zenkutu.L_leg_flag == true ||
            _zenkutu.R_leg_flag == true)
        {
            _chance = true;
            ChanceDisPlayTrue();
        }
    ...
    {
        if ((_zenkutu.R_arm_flag == true &&
            _zenkutu.L_arm_flag == true) ||
            (_zenkutu.R_leg_flag == true &&
            _zenkutu.L_leg_flag == true))
        {
            _posemanager._Pose = PoseManager.PoseState.Zenkutu;
        }
