...
public class State_spuat : MonoBehaviour {
    ...
    /****ポーズオブジェクトの取得****/
    // 開脚のオブジェクトを取得
    private Image _Spuat;
    public Pose_spuat _spuat;
    ...
    void Start()
    {
        ...
        _Spuat = GameObject.Find("Pose_spuat").GetComponent<Image>();
        _spuat = _Spuat.GetComponent<Pose_spuat>();
    ...
    void Update()
    {
        ...
        if (_spuat.L_arm_flag == true ||
            _spuat.R_arm_flag == true ||
            _spuat.L_leg_flag == true ||
            _spuat.R_leg_flag == true)
        {
            _chance = true;
            ChanceDisPlayTrue();
        }
    ...
    {
        if ((_spuat.R_arm_flag == true &&
            _spuat.L_arm_flag == true) ||
            (_spuat.R_leg_flag == true &&
            _spuat.L_leg_flag == true))
        {
            _posemanager._Pose = PoseManager.PoseState.Conveni;
        }
